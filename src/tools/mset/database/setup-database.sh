...
##### This script was found on the github: https://github.com/macadmins/postgres/blob/master/setup-database.sh#L5 ##### 
##### This script is used to set up a database with appropriate logins.                                           #####
