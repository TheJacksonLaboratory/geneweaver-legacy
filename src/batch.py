...
#### eatWhiteSpace
##
#### Removes any leading and trailing white space from a string.
##
def eatWhiteSpace(s):
	return s.strip()
...
#### readBatchFile
##
#### Given a file path, the function reads the file and returns a list of lines.
##
...
#### makeDigrams
##
#### Creates an exhaustive list of digrams found in the given string.
##
def makeDigrams(s):
    if len(s) <= 2:
        return [s]
...
#### to determine the right microarray platform to use. Don't ask me why! I'm
#### just rewriting the damn batch script.
...
#### parseScoreType
##
#### Given a string, this function attempts to parse out the score type and
#### any threshold value that is part of the score type.
...
#### (e.g. 0.05) are used.
#### The function returns a tuple (gs_threshold_type, gs_threshold, errors).
##
...
#### The function gets a list of strings (lines) as input and returns
#### a list of dictionaries, each dictionary is a geneset and all
#### the relevant data associated with it.
#### Takes to additional (optional) params, usr and cur, which can be
#### entered through the command line to provide usr_ids and cur_ids.
##
